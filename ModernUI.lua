...
function ModernUI:CreateWindow(Config)
    ...
    local ScreenGui = Create("ScreenGui", {
        Name = "ModernUILib",
        Parent = game.CoreGui, -- Fallback to PlayerGui if CoreGui fails in some executors
    ...
    local MainFrame = Create("Frame", {
        ...
        Size = UDim2.fromScale(0, 0), -- Animation Start
        BorderSizePixel = 0,
    ...
    function Window:Tab(Name)
        ...
        function Elements:Slider(Text, Min, Max, Default, Callback)
            ...
            local function UpdateSlider(input)
                ...
                local Value = math.floor(((Pos.X.Scale * (Max - Min)) + Min) * 100) / 100 -- 2 decimals
